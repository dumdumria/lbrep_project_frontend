    ...
    useEffect(() => {
        async function GetListingInfo() {
            try {
                ...
                console.log("Listing seller ID:", response.data?.seller);

            } catch (e) {
                console.error("Error fetching listing info", e);
            }
        }
        GetListingInfo();
    }, []);
        ...
        >
            ...
            >
                ...
                <Grid item container xs={5} alignItems="center">
                    {state.listingInfo.price !== undefined && state.listingInfo.listing_type ? (
                        <Typography
                            variant="h6"
            ...
            <Grid item container style={{ marginTop: "1rem" }} spacing={1} justifyContent="space-between">
                <Grid item xs={3} style={{ overflow: "auto", height: "35rem" }}>
                    ...
                    {/* Your existing POI mapping code */}
                ...
                <Grid item xs={9} style={{ height: "35rem", width: "70%" }}>
